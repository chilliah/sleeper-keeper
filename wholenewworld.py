...
def save_keeper_table(table_debug, table_league, keeper_df):
    ...
    if refresh:
        ...
        if draft_type == 'auction':
            ...
            human_full_column_list = ['Owner', 'Player', 'Position', 'Years Kept', 'Draft Cost($)',
                                      'Keeper Cost($)', 'Eligible', 'Note']
            ...
            human_full_column_list = ['Owner', 'Player', 'Position', 'Old Years Kept', 'New Years Kept',
                                      'Draft Round', 'Keeper Cost', 'Eligible', 'Note']
            keeper_human_full_df.columns = human_full_column_list
        ...
        if draft_type == 'auction':
            ...
            filter_column_list = ['Owner', 'Player', 'Position', 'Years Kept', 'Keeper Cost', 'Note', 'Eligible']
...
def save_kept_players_table(kept_debug, kept_league, kept_players_df):
    ...
    kept_players_csv_location = f'data_files/{year}/{league_id}/kept_players/kept_debug_generaged_players.csv'
