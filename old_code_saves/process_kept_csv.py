...
# This is a helper script for old_sleeper_keeper.py.
...
# old_sleeper_keeper.py will use when determining eligible keepers.
...
def add_sleeper_information():
    ...
    # Save as processed_kept_players.json to be used in old_sleeper_keeper.py
